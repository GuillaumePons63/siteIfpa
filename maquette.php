    ...
    <div class="col-12" style="height: 200px;" >
        <div class="collapse" id="exercice1">
            <div class="h-100 d-inline-block card card-body">
                ...
                <a class="btn btn-primary col-4 d-block m-auto" href="./maquettes/maquette1.zip" download> Télécharger le projet </a>
            </div>
        </div>
        <div class="collapse" id="exercice2">
            <div class="h-100 d-inline-block card card-body">
                ...
                <a class="btn btn-primary col-4 d-block m-auto" href="./maquettes/maquette2.zip" download> Télécharger le projet </a>
            </div>
        </div>
        <div class="collapse" id="exercice3">
            <div class="h-100 d-inline-block card card-body">
                ...
                <a class="btn btn-primary col-4 d-block m-auto" href="./maquettes/Tajam.zip" download> Télécharger le projet </a>
            </div>
        </div>
    </div>
</main>
